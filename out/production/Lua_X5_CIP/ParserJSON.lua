...
--package.path = package.path..";D:/Work/Projects/Lua/Lua_X5_CIP/out/production/Lua_X5_CIP/Clm5Accounts.lua"
local clm5_accounts = require('Clm5Accounts')

function create_clm5_accounts()
    local accounts = {}
    if not clm5_accounts then
        accounts = clm5_accounts:new(create_parameters_for_accounts(table_from_json))
    else
        print('not import')
    end
